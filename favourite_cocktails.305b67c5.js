...
function av(){return(av=t(a)(t(u).mark((function e(){return t(u).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return ce(ue),le(ue),e.next=4,Ie();case 4:P.addEventListener("click",(function(e){return ye(e)})),L.addEventListener("click",(function(e){return be(e)})),A.addEventListener("click",ge);case 7:case"end":return e.stop()}}),e)})))).apply(this,arguments)}!function(){av.apply(this,arguments)}()}();
//# sourceMappingURL=favourite_cocktails.305b67c5.js.map
