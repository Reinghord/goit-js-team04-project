 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xe(e){return JSON.parse(e)}function De(e){return JSON.stringify(e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Me=function(e){let t={},n={},i={},r="";try{const s=e.split(".");t=xe(ye(s[0])||""),n=xe(ye(s[1])||""),r=s[2],i=n.d||{},delete n.d}catch(e){}return{header:t,claims:n,data:i,signature:r}},Ue=function(e){const t=Me(e).claims;return!!t&&"object"==typeof t&&t.hasOwnProperty("iat")},Fe=function(e){const t=Me(e).claims;return"object"==typeof t&&!0===t.admin};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class At{getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}constructor(e){this.container=e}}const Pt=new ft("@firebase/app"),Lt={"@firebase/app":"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},xt=new Map,Dt=new Map;function Mt(e,t){try{e.container.addComponent(t)}catch(n){Pt.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Ut(e){const t=e.name;if(Dt.has(t))return Pt.debug(`There were multiple attempts to register component ${t}.`),!1;Dt.set(t,e);for(const t of xt.values())Mt(t,e);return!0}function Ft(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Bt=new Pe("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zt(e="[DEFAULT]"){const t=xt.get(e);if(!t)throw Bt.create("no-app",{appName:e});return t}function qt(e,t,n){var i;let r=null!==(i=Lt[e])&&void 0!==i?i:e;n&&(r+=`-${n}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const e=[`Unable to register library "${r}" with version "${t}":`];return s&&e.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void Pt.warn(e.join(" "))}Ut(new it(`${r}-version`,(()=>({library:r,version:t})),"VERSION"))}let Wt=null;function Ht(){return Wt||(Wt=kt("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw Bt.create("idb-open",{originalErrorMessage:e.message})}))),Wt}async function $t(e,t){var n;try{const n=(await Ht()).transaction("firebase-heartbeat-store","readwrite"),i=n.objectStore("firebase-heartbeat-store");return await i.put(t,Vt(e)),n.done}catch(e){if(e instanceof Ae)Pt.warn(e.message);else{const t=Bt.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});Pt.warn(t.message)}}}function Vt(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Qt;Qt="",Ut(new it("platform-logger",(e=>new At(e)),"PRIVATE")),Ut(new it("heartbeat",(e=>new Kt(e)),"PRIVATE")),qt("@firebase/app","0.7.30",Qt),qt("@firebase/app","0.7.30","esm2017"),qt("fire-js","");
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
qt("firebase","9.9.2","app");const Xt=new Pe("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function Zt(e){return e instanceof Ae&&e.code.includes("request-failed")}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function In(e){let t;const n=await bn(e.appConfig,(n=>{const i=function(e){return Cn(e||{fid:ln(),registrationStatus:0})}(n),r=function(e,t){if(0===t.registrationStatus){if(!navigator.onLine){return{installationEntry:t,registrationPromise:Promise.reject(Xt.create("app-offline"))}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},i=async function(e,t){try{const n=await async function({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const i=en(e),r=rn(e),s=t.getImmediate({optional:!0});if(s){const e=await s.getHeartbeatsHeader();e&&r.append("x-firebase-client",e)}const o={fid:n,authVersion:"FIS_v2",appId:e.appId,sdkVersion:"w:0.5.12"},a={method:"POST",headers:r,body:JSON.stringify(o)},c=await on((()=>fetch(i,a)));if(c.ok){const e=await c.json();return{fid:e.fid||n,registrationStatus:2,refreshToken:e.refreshToken,authToken:tn(e.authToken)}}throw await nn("Create Installation",c)}(e,t);return vn(e.appConfig,n)}catch(n){throw Zt(n)&&409===n.customData.serverCode?await wn(e.appConfig):await vn(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}(e,n);return{installationEntry:n,registrationPromise:i}}return 1===t.registrationStatus?{installationEntry:t,registrationPromise:Tn(e)}:{installationEntry:t}}(e,i);return t=r.registrationPromise,r.installationEntry}));return""===n.fid?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}async function Tn(e){let t=await En(e.appConfig);for(;1===t.registrationStatus;)await an(100),t=await En(e.appConfig);if(0===t.registrationStatus){const{installationEntry:t,registrationPromise:n}=await In(e);return n||t}return t}function En(e){return bn(e,(e=>{if(!e)throw Xt.create("installation-not-found");return Cn(e)}))}function Cn(e){return 1===(t=e).registrationStatus&&t.registrationTime+1e4<Date.now()?{fid:e.fid,registrationStatus:0}:e;var t;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function On(e,t=!1){const n=e;await async function(e){const{registrationPromise:t}=await In(e);t&&await t}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n);return(await Sn(n,t)).token}function An(e){return Xt.create("missing-app-config-values",{valueName:e})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pn=e=>{const t=Ft(e.getProvider("app").getImmediate(),"installations").getImmediate();return{getId:()=>async function(e){const t=e,{installationEntry:n,registrationPromise:i}=await In(t);return i?i.catch(console.error):Sn(t).catch(console.error),n.fid}(t),getToken:e=>On(t,e)}};Ut(new it("installations",(e=>{const t=e.getProvider("app").getImmediate(),n=
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){if(!e||!e.options)throw An("App Configuration");if(!e.name)throw An("App Name");const t=["projectId","apiKey","appId"];for(const n of t)if(!e.options[n])throw An(n);return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}(t);return{app:t,appConfig:n,heartbeatServiceProvider:Ft(t,"heartbeat"),_delete:()=>Promise.resolve()}}),"PUBLIC")),Ut(new it("installations-internal",Pn,"PRIVATE")),qt("@firebase/installations","0.5.12"),qt("@firebase/installations","0.5.12","esm2017");
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ln=new ft("@firebase/analytics");
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function xn(e){return Promise.all(e.map((e=>e.catch((e=>e)))))}function Dn(e,t,n,i){return async function(r,s,o){try{"event"===r?await async function(e,t,n,i,r){try{let s=[];if(r&&r.send_to){let e=r.send_to;Array.isArray(e)||(e=[e]);const i=await xn(n);for(const n of e){const e=i.find((e=>e.measurementId===n)),r=e&&t[e.appId];if(!r){s=[];break}s.push(r)}}0===s.length&&(s=Object.values(t)),await Promise.all(s),e("event",i,r||{})}catch(e){Ln.error(e)}}(e,t,n,s,o):"config"===r?await async function(e,t,n,i,r,s){const o=i[r];try{if(o)await t[o];else{const e=(await xn(n)).find((e=>e.measurementId===r));e&&await t[e.appId]}}catch(e){Ln.error(e)}e("config",r,s)}(e,t,n,i,s,o):"consent"===r?e("consent","update",o):e("set",s)}catch(e){Ln.error(e)}}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qn,Wn;function Hn(e){Wn=e}function $n(e){qn=e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kn{_delete(){return delete Gn[this.app.options.appId],Promise.resolve()}constructor(e){this.app=e}}let Gn={},Jn=[];const Yn={};let Qn,Xn,Zn="dataLayer",ei="gtag",ti=!1;function ni(e,t,n){!function(){const e=[];if(Ee()&&e.push("This is a browser extension environment."),Oe()||e.push("Cookies are not available."),e.length>0){const t=e.map(((e,t)=>`(${t+1}) ${e}`)).join(" "),n=Mn.create("invalid-analytics-context",{errorInfo:t});Ln.warn(n.message)}}();const i=e.options.appId;if(!i)throw Mn.create("no-app-id");if(!e.options.apiKey){if(!e.options.measurementId)throw Mn.create("no-api-key");Ln.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`)}if(null!=Gn[i])throw Mn.create("already-exists",{id:i});if(!ti){!function(e){let t=[];Array.isArray(window[e])?t=window[e]:window[e]=t}(Zn);const{wrappedGtag:e,gtagCore:t}=function(e,t,n,i,r){let s=function(...e){window[i].push(arguments)};return window[r]&&"function"==typeof window[r]&&(s=window[r]),window[r]=Dn(s,e,t,n),{gtagCore:s,wrappedGtag:window[r]}}(Gn,Jn,Yn,Zn,ei);Xn=e,Qn=t,ti=!0}Gn[i]=Vn(e,Jn,Yn,t,Qn,Zn,n);return new Kn(e)}function ii(e,t,n,i){e=nt(e),async function(e,t,n,i,r){if(r&&r.global)e("event",n,i);else{const r=await t;e("event",n,Object.assign(Object.assign({},i),{send_to:r}))}}(Xn,Gn[e.app.options.appId],t,n,i).catch((e=>Ln.error(e)))}Ut(new it("analytics",((e,{options:t})=>ni(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),t)),"PUBLIC")),Ut(new it("analytics-internal",(function(e){try{const t=e.getProvider("analytics").getImmediate();return{logEvent:(e,n,i)=>ii(t,e,n,i)}}catch(e){throw Mn.create("interop-component-reg-failed",{reason:e})}}),"PRIVATE")),qt("@firebase/analytics","0.8.0"),qt("@firebase/analytics","0.8.0","esm2017");function ri(e,t){var n={};for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&t.indexOf(i)<0&&(n[i]=e[i]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var r=0;for(i=Object.getOwnPropertySymbols(e);r<i.length;r++)t.indexOf(i[r])<0&&Object.prototype.propertyIsEnumerable.call(e,i[r])&&(n[i[r]]=e[i[r]])}return n}Object.create;Object.create;function si(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const oi=si,ai=new Pe("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),ci=new ft("@firebase/auth");function li(e,...t){ci.logLevel<=at.ERROR&&ci.error(`Auth (9.9.2): ${e}`,...t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ti{get(){return"undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(bi()||Ee()||"connection"in navigator)&&!navigator.onLine?Math.min(5e3,this.shortDelay):this.isMobile?this.longDelay:this.shortDelay}constructor(e,t){this.shortDelay=e,this.longDelay=t,_i(t>e,"Short delay should be less than long delay!"),this.isMobile=Te()||Ce()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ei(e,t){_i(e.emulator,"Emulator should always be set here");const{url:n}=e.emulator;return t?`${n}${t.startsWith("/")?t.slice(1):t}`:n}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ri(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function Ni(e,t,n,i,r={}){return Oi(e,r,(async()=>{let r={},s={};i&&("GET"===t?s=i:r={body:JSON.stringify(i)});const o=$e(Object.assign({key:e.config.apiKey},s)).slice(1),a=await e._getAdditionalHeaders();return a["Content-Type"]="application/json",e.languageCode&&(a["X-Firebase-Locale"]=e.languageCode),Ci.fetch()(Pi(e,e.config.apiHost,n,o),Object.assign({method:t,headers:a,referrerPolicy:"no-referrer"},r))}))}async function Oi(e,t,n){e._canInitEmulator=!1;const i=Object.assign(Object.assign({},ki),t);try{const t=new Li(e),r=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const s=await r.json();if("needConfirmation"in s)throw xi(e,"account-exists-with-different-credential",s);if(r.ok&&!("errorMessage"in s))return s;{const t=r.ok?s.errorMessage:s.error.message,[n,o]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw xi(e,"credential-already-in-use",s);if("EMAIL_EXISTS"===n)throw xi(e,"email-already-in-use",s);if("USER_DISABLED"===n)throw xi(e,"user-disabled",s);const a=i[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(o)throw di(e,a,o);ui(e,a)}}catch(t){if(t instanceof Ae)throw t;ui(e,"network-request-failed")}}async function Ai(e,t,n,i,r={}){const s=await Ni(e,t,n,i,r);return"mfaPendingCredential"in s&&ui(e,"multi-factor-auth-required",{_serverResponse:s}),s}function Pi(e,t,n,i){const r=`${t}${n}?${i}`;return e.config.emulator?Ei(e.config,r):`${e.config.apiScheme}://${r}`}class Li{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(hi(this.auth,"network-request-failed"))),Si.get())}))}}function xi(e,t,n){const i={appName:e.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const r=hi(e,t,i);return r.customData._tokenResponse=n,r}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Fi(e,t,n=!1){if(n)return t;try{return await t}catch(t){throw t instanceof Ae&&function({code:e}){return"auth/user-disabled"===e||"auth/user-token-expired"===e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class qi{get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){gi(e.idToken,"internal-error"),gi(void 0!==e.idToken,"internal-error"),gi(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=Ui(e);return gi(t,"internal-error"),gi(void 0!==t.exp,"internal-error"),gi(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return gi(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:r}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function(e,t){const n=await Oi(e,{},(async()=>{const n=$e({grant_type:"refresh_token",refresh_token:t}).slice(1),{tokenApiHost:i,apiKey:r}=e.config,s=Pi(e,i,"/v1/token",`key=${r}`),o=await e._getAdditionalHeaders();return o["Content-Type"]="application/x-www-form-urlencoded",Ci.fetch()(s,{method:"POST",headers:o,body:n})}));return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}(e,t);this.updateTokensAndExpiration(n,i,Number(r))}updateTokensAndExpiration(e,t,n){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+1e3*n}static fromJSON(e,t){const{refreshToken:n,accessToken:i,expirationTime:r}=t,s=new qi;return n&&(gi("string"==typeof n,"internal-error",{appName:e}),s.refreshToken=n),i&&(gi("string"==typeof i,"internal-error",{appName:e}),s.accessToken=i),r&&(gi("number"==typeof r,"internal-error",{appName:e}),s.expirationTime=r),s}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new qi,this.toJSON())}_performRefresh(){return mi("not implemented")}constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
return async function(e,t){return Ai(e,"POST","/v1/accounts:signInWithPassword",Ri(e,t))}(e,{returnSecureToken:!0,email:this._email,password:this._password});case"emailLink":
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pr(e,t){return Ai(e,"POST","/v1/accounts:signInWithIdp",Ri(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class _r extends hr{static _fromVerification(e,t){return new _r({verificationId:e,verificationCode:t})}static _fromTokenResponse(e,t){return new _r({phoneNumber:e,temporaryProof:t})}_getIdTokenResponse(e){return async function(e,t){return Ai(e,"POST","/v1/accounts:signInWithPhoneNumber",Ri(e,t))}(e,this._makeVerificationRequest())}_linkToIdToken(e,t){return async function(e,t){const n=await Ai(e,"POST","/v1/accounts:signInWithPhoneNumber",Ri(e,t));if(n.temporaryProof)throw xi(e,"account-exists-with-different-credential",n);return n}(e,Object.assign({idToken:t},this._makeVerificationRequest()))}_getReauthenticationResolver(e){return async function(e,t){return Ai(e,"POST","/v1/accounts:signInWithPhoneNumber",Ri(e,Object.assign(Object.assign({},t),{operation:"REAUTH"})),mr)}(e,this._makeVerificationRequest())}_makeVerificationRequest(){const{temporaryProof:e,phoneNumber:t,verificationId:n,verificationCode:i}=this.params;return e&&t?{temporaryProof:e,phoneNumber:t}:{sessionInfo:n,code:i}}toJSON(){const e={providerId:this.providerId};return this.params.phoneNumber&&(e.phoneNumber=this.params.phoneNumber),this.params.temporaryProof&&(e.temporaryProof=this.params.temporaryProof),this.params.verificationCode&&(e.verificationCode=this.params.verificationCode),this.params.verificationId&&(e.verificationId=this.params.verificationId),e}static fromJSON(e){"string"==typeof e&&(e=JSON.parse(e));const{verificationId:t,verificationCode:n,phoneNumber:i,temporaryProof:r}=e;return n||t||i||r?new _r({verificationId:t,verificationCode:n,phoneNumber:i,temporaryProof:r}):null}constructor(e){super("phone","phone"),this.params=e}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Cr extends br{static credential(e,t){return gr._fromParams({providerId:Cr.PROVIDER_ID,signInMethod:Cr.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Cr.credentialFromTaggedObject(e)}static credentialFromError(e){return Cr.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:n}=e;if(!t||!n)return null;try{return Cr.credential(t,n)}catch(e){return null}}constructor(){super("twitter.com")}}Cr.TWITTER_SIGN_IN_METHOD="twitter.com",Cr.PROVIDER_ID="twitter.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Or(e,t,n=!1){const i=await Fi(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return kr._forOperation(e,"link",i)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Ar(e,t,n=!1){var i;const{auth:r}=e,s="reauthenticate";try{const i=await Fi(e,Nr(r,s,t,e),n);gi(i.idToken,r,"internal-error");const o=Ui(i.idToken);gi(o,r,"internal-error");const{sub:a}=o;return gi(e.uid===a,r,"user-mismatch"),kr._forOperation(e,s,i)}catch(e){throw"auth/user-not-found"===(null===(i=e)||void 0===i?void 0:i.code)&&ui(r,"user-mismatch"),e}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pr(e,t,n=!1){const i="signIn",r=await Nr(e,i,t),s=await kr._fromIdTokenResponse(e,i,r);return n||await e._updateCurrentUser(s.user),s}new WeakMap;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mr extends Lr{_addListener(e,t){}_removeListener(e,t){}constructor(){super((()=>window.sessionStorage),"SESSION")}}Mr.type="SESSION";const Ur=Mr;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Is=new Ti(3e4,6e4);function Ts(){const e=zr().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Es=null;function Cs(e){return Es=Es||function(e){return new Promise(((t,n)=>{var i,r,s;function o(){Ts(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Ts(),n(hi(e,"network-request-failed"))},timeout:Is.get()})}if(null===(r=null===(i=zr().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=zr().gapi)||void 0===s?void 0:s.load)){const t=Qr("iframefcb");return zr()[t]=()=>{gapi.load?o():n(hi(e,"network-request-failed"))},Yr(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw Es=null,e}))}(e),Es}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const Os={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"};class As{close(){if(this.window)try{this.window.close()}catch(e){}}constructor(e){this.window=e,this.associatedEvent=null}}function Ps(e,t,n,i=500,r=600){const s=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const c=Object.assign(Object.assign({},Os),{width:i.toString(),height:r.toString(),top:s,left:o}),l=Ie().toLowerCase();n&&(a=Xi(l)?"_blank":n),Yi(l)&&(t=t||"http://localhost",c.scrollbars="yes");const u=Object.entries(c).reduce(((e,[t,n])=>`${e}${t}=${n},`),"");if(function(e=Ie()){var t;return ir(e)&&!!(null===(t=window.navigator)||void 0===t?void 0:t.standalone)}(l)&&"_self"!==a)return function(e,t){const n=document.createElement("a");n.href=e,n.target=t;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",a),new As(null);const h=window.open(t||"",a,u);gi(h,e,"popup-blocked");try{h.focus()}catch(e){}return new As(h)}function Ls(e,t,n,i,r,s){gi(e.config.authDomain,e,"auth-domain-config-required"),gi(e.config.apiKey,e,"invalid-api-key");const o={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:i,v:"9.9.2",eventId:r};if(t instanceof wr){t.setDefaultLanguage(e.languageCode),o.providerId=t.providerId||"",ze(t.getCustomParameters())||(o.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(s||{}))o[e]=t}if(t instanceof br){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(o.scopes=e.join(","))}e.tenantId&&(o.tid=e.tenantId);const a=o;for(const e of Object.keys(a))void 0===a[e]&&delete a[e];return`${function({config:e}){return e.emulator?Ei(e,"emulator/auth/handler"):`https://${e.authDomain}/__/auth/handler`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${$e(a).slice(1)}`}const xs=class{async _openPopup(e,t,n,i){var r;_i(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return Ps(e,Ls(e,t,n,wi(),i),Br())}async _openRedirect(e,t,n,i){var r;return await this._originValidation(e),r=Ls(e,t,n,wi(),i),zr().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(_i(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await Cs(e),n=zr().gapi;return gi(n,e,"internal-error"),t.open({where:document.body,url:Ns(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Ss,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const r=hi(e,"network-request-failed"),s=zr().setTimeout((()=>{i(r)}),ks.get());function o(){zr().clearTimeout(s),n(t)}t.ping(o).then(o,(()=>{i(r)}))}))))}(e),n=new gs(e);return t.register("authEvent",(t=>{gi(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&t(!!r),ui(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=ws(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return sr()||Qi()||ir()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ur,this._completeRedirectFn=ps,this._overrideRedirectResult=hs}};var Ds;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class vo{isCacheableHost(){return"s-"===this.internalHost.substr(0,2)}isCustomHost(){return"firebaseio.com"!==this._domain&&"firebaseio-demo.com"!==this._domain}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&qs.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}constructor(e,t,n,i,r=!1,s="",o=!1){this.secure=t,this.namespace=n,this.webSocketOnly=i,this.nodeAdmin=r,this.persistenceKey=s,this.includeNamespaceInQueryParams=o,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=qs.get("host:"+e)||this._host}}function wo(e,t,n){let i;if(de("string"==typeof t,"typeof type must == string"),de("object"==typeof n,"typeof params must == object"),"websocket"===t)i=(e.secure?"wss://":"ws://")+e.internalHost+"/.ws?";else{if("long_polling"!==t)throw new Error("Unknown connection type: "+t);i=(e.secure?"https://":"http://")+e.internalHost+"/.lp?"}(function(e){return e.host!==e.internalHost||e.isCustomHost()||e.includeNamespaceInQueryParams})(e)&&(n.ns=e.namespace);const r=[];return co(n,((e,t)=>{r.push(e+"="+t)})),i+r.join("&")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Io={},To={};function Eo(e){const t=e.toString();return Io[t]||(Io[t]=new bo),Io[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Co{closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const e=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let t=0;t<e.length;++t)e[t]&&fo((()=>{this.onMessage_(e[t])}));if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo extends Lo{static getInstance(){return new xo}getInitialEvent(e){return de("online"===e,"Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}constructor(){super(["online"]),this.online_=!0,"undefined"==typeof window||void 0===window.addEventListener||Te()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xo extends Lo{static getInstance(){return new Xo}getInitialEvent(e){return de("visible"===e,"Unknown event type: "+e),[this.visible_]}constructor(){let e,t;super(["visible"]),"undefined"!=typeof document&&void 0!==document.addEventListener&&(void 0!==document.hidden?(t="visibilitychange",e="hidden"):void 0!==document.mozHidden?(t="mozvisibilitychange",e="mozHidden"):void 0!==document.msHidden?(t="msvisibilitychange",e="msHidden"):void 0!==document.webkitHidden&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,(()=>{const t=!document[e];t!==this.visible_&&(this.visible_=t,this.trigger("visible",t))}),!1)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ra extends ta{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),r=n.compareTo(i);return 0===r?io(e.name,t.name):r}makePost(e,t){const n=Sa(e),i=Ca.EMPTY_NODE.updateChild(this.indexPath_,n);return new ea(t,i)}maxPost(){const e=Ca.EMPTY_NODE.updateChild(this.indexPath_,ka);return new ea("[MAX_NAME]",e)}toString(){return zo(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,de(!Ho(e)&&".priority"!==Uo(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Aa(e){return{type:"value",snapshotNode:e}}function Pa(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function La(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function xa(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fa extends Po{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(de(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const s=Fa.getListenId_(e,n),o={};this.listens_[s]=o;const a=Ma(e._queryParams);this.restRequest_(r+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(r,a,!1,n),je(this.listens_,s)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=Fa.getListenId_(e,t);delete this.listens_[n]}get(e){const t=Ma(e._queryParams),n=e._path.toString(),i=new be;return this.restRequest_(n+".json",t,((e,t)=>{let r=t;404===e&&(r=null,e=null),null===e?(this.onDataUpdate_(n,r,!1,null),i.resolve(r)):i.reject(new Error(r))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,r])=>{i&&i.accessToken&&(t.auth=i.accessToken),r&&r.token&&(t.ac=r.token);const s=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+$e(t);this.log_("Sending REST request for "+s);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+s+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=xe(o.responseText)}catch(e){to("Failed to parse JSON response for "+s+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&to("Got unsuccessful REST response for "+s+" Status: "+o.status),n(o.status);n=null}},o.open("GET",s,!0),o.send()}))}constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=Xs("p:rest:"),this.listens_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ba{getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}constructor(){this.rootNode_=Ca.EMPTY_NODE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ja(){return{value:null,children:new Map}}function za(e,t,n){if(Ho(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const i=Uo(t);e.children.has(i)||e.children.set(i,ja());za(e.children.get(i),t=Bo(t),n)}}function qa(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{qa(i,new Do(t.toString()+"/"+e),n)}))}class Wa{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&co(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ha{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;co(e,((e,i)=>{i>0&&Be(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),po(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Wa(e);const n=1e4+2e4*Math.random();po(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var $a,Va;function Ka(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Va=$a||($a={}))[Va.OVERWRITE=0]="OVERWRITE",Va[Va.MERGE=1]="MERGE",Va[Va.ACK_USER_WRITE=2]="ACK_USER_WRITE",Va[Va.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class Ga{operationForChild(e){if(Ho(this.path)){if(null!=this.affectedTree.value)return de(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Do(e));return new Ga(Mo(),t,this.revert)}}return de(Uo(this.path)===e,"operationForChild called for unrelated child."),new Ga(Bo(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=$a.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ja{operationForChild(e){return Ho(this.path)?new Ja(this.source,Mo(),this.snap.getImmediateChild(e)):new Ja(this.source,Bo(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=$a.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ya{operationForChild(e){if(Ho(this.path)){const t=this.children.subtree(new Do(e));return t.isEmpty()?null:t.value?new Ja(this.source,Mo(),t.value):new Ya(this.source,Mo(),t)}return de(Uo(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ya(this.source,Bo(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=$a.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xa(e,t,n,i,r,s){const o=i.filter((e=>e.type===n));o.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw fe("Should only compare child_ events.");const i=new ea(t.childName,t.snapshotNode),r=new ea(n.childName,n.snapshotNode);return e.index_.compare(i,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),o.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,s);r.forEach((r=>{r.respondsTo(n.type)&&t.push(r.createEvent(i,e.query_))}))}))}function Za(e,t){return{eventCache:e,serverCache:t}}function ec(e,t,n,i){return Za(new Qa(t,n,i),e.serverCache)}function tc(e,t,n,i){return Za(e.eventCache,new Qa(t,n,i))}function nc(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function ic(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oc{static empty(){return new oc(new sc(null))}constructor(e){this.writeTree_=e}}function ac(e,t,n){if(Ho(t))return new oc(new sc(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let s=i.value;const o=$o(r,t);return s=s.updateChild(o,n),new oc(e.writeTree_.set(r,s))}{const i=new sc(n),r=e.writeTree_.setTree(t,i);return new oc(r)}}}function cc(e,t,n){let i=e;return co(n,((e,n)=>{i=ac(i,Wo(t,e),n)})),i}function lc(e,t){if(Ho(t))return oc.empty();{const n=e.writeTree_.setTree(t,new sc(null));return new oc(n)}}function uc(e,t){return null!=hc(e,t)}function hc(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild($o(n.path,t)):null}function dc(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(_a,((e,n)=>{t.push(new ea(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new ea(e,n.value))})),t}function fc(e,t){if(Ho(t))return e;{const n=hc(e,t);return new oc(null!=n?new sc(n):e.writeTree_.subtree(t))}}function pc(e){return e.writeTree_.isEmpty()}function gc(e,t){return mc(Mo(),e.writeTree_,t)}function mc(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,r)=>{".priority"===t?(de(null!==r.value,"Priority writes must always be leaf nodes"),i=r.value):n=mc(Wo(e,t),r,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(Wo(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _c(e,t){return Oc(t,e)}function yc(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));de(n>=0,"removeWrite called with nonexistent writeId.");const i=e.allWrites[n];e.allWrites.splice(n,1);let r=i.visible,s=!1,o=e.allWrites.length-1;for(;r&&o>=0;){const t=e.allWrites[o];t.visible&&(o>=n&&vc(t,i.path)?r=!1:Go(i.path,t.path)&&(s=!0)),o--}if(r){if(s)return function(e){e.visibleWrites=bc(e.allWrites,wc,Mo()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(i.snap)e.visibleWrites=lc(e.visibleWrites,i.path);else{co(i.children,(t=>{e.visibleWrites=lc(e.visibleWrites,Wo(i.path,t))}))}return!0}return!1}function vc(e,t){if(e.snap)return Go(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&Go(Wo(e.path,n),t))return!0;return!1}function wc(e){return e.visible}function bc(e,t,n){let i=oc.empty();for(let r=0;r<e.length;++r){const s=e[r];if(t(s)){const e=s.path;let t;if(s.snap)Go(n,e)?(t=$o(n,e),i=ac(i,t,s.snap)):Go(e,n)&&(t=$o(e,n),i=ac(i,Mo(),s.snap.getChild(t)));else{if(!s.children)throw fe("WriteRecord should have .snap or .children");if(Go(n,e))t=$o(n,e),i=cc(i,t,s.children);else if(Go(e,n))if(t=$o(e,n),Ho(t))i=cc(i,Mo(),s.children);else{const e=je(s.children,Uo(t));if(e){const n=e.getChild(Bo(t));i=ac(i,Mo(),n)}}}}}return i}function Ic(e,t,n,i,r){if(i||r){const s=fc(e.visibleWrites,t);if(!r&&pc(s))return n;if(r||null!=n||uc(s,Mo())){const s=function(e){return(e.visible||r)&&(!i||!~i.indexOf(e.writeId))&&(Go(e.path,t)||Go(t,e.path))};return gc(bc(e.allWrites,s,t),n||Ca.EMPTY_NODE)}return null}{const i=hc(e.visibleWrites,t);if(null!=i)return i;{const i=fc(e.visibleWrites,t);if(pc(i))return n;if(null!=n||uc(i,Mo())){return gc(i,n||Ca.EMPTY_NODE)}return null}}}function Tc(e,t,n,i){return Ic(e.writeTree,e.treePath,t,n,i)}function Ec(e,t){return function(e,t,n){let i=Ca.EMPTY_NODE;const r=hc(e.visibleWrites,t);if(r)return r.isLeafNode()||r.forEachChild(_a,((e,t)=>{i=i.updateImmediateChild(e,t)})),i;if(n){const r=fc(e.visibleWrites,t);return n.forEachChild(_a,((e,t)=>{const n=gc(fc(r,new Do(e)),t);i=i.updateImmediateChild(e,n)})),dc(r).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}return dc(fc(e.visibleWrites,t)).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}(e.writeTree,e.treePath,t)}function Cc(e,t,n,i){return function(e,t,n,i,r){de(i||r,"Either existingEventSnap or existingServerSnap must exist");const s=Wo(t,n);if(uc(e.visibleWrites,s))return null;{const t=fc(e.visibleWrites,s);return pc(t)?r.getChild(n):gc(t,r.getChild(n))}}(e.writeTree,e.treePath,t,n,i)}function kc(e,t){return function(e,t){return hc(e.visibleWrites,t)}(e.writeTree,Wo(e.treePath,t))}function Sc(e,t,n,i,r,s){return function(e,t,n,i,r,s,o){let a;const c=fc(e.visibleWrites,t),l=hc(c,Mo());if(null!=l)a=l;else{if(null==n)return[];a=gc(c,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=s?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let c=n.getNext();for(;c&&e.length<r;)0!==t(c,i)&&e.push(c),c=n.getNext();return e}}(e.writeTree,e.treePath,t,n,i,r,s)}function Rc(e,t,n){return function(e,t,n,i){const r=Wo(t,n),s=hc(e.visibleWrites,r);if(null!=s)return s;if(i.isCompleteForChild(n))return gc(fc(e.visibleWrites,r),i.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function Nc(e,t){return Oc(Wo(e.treePath,t),e.writeTree)}function Oc(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ac{trackChildChange(e){const t=e.type,n=e.childName;de("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),de(".priority"!==n,"Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const r=i.type;if("child_added"===t&&"child_removed"===r)this.changeMap.set(n,xa(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===r)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===r)this.changeMap.set(n,La(n,i.oldSnap));else if("child_changed"===t&&"child_added"===r)this.changeMap.set(n,Pa(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==r)throw fe("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,xa(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}constructor(){this.changeMap=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pc=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class Lc{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Qa(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Rc(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:ic(this.viewCache_),r=Sc(this.writes_,i,t,1,n,e);return 0===r.length?null:r[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xc(e,t,n,i,r){const s=new Ac;let o,a;if(n.type===$a.OVERWRITE){const c=n;c.source.fromUser?o=Uc(e,t,c.path,c.snap,i,r,s):(de(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!Ho(c.path),o=Mc(e,t,c.path,c.snap,i,r,a,s))}else if(n.type===$a.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,i,r,s,o){let a=t;return i.foreach(((i,c)=>{const l=Wo(n,i);Fc(t,Uo(l))&&(a=Uc(e,a,l,c,r,s,o))})),i.foreach(((i,c)=>{const l=Wo(n,i);Fc(t,Uo(l))||(a=Uc(e,a,l,c,r,s,o))})),a}(e,t,c.path,c.children,i,r,s):(de(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=jc(e,t,c.path,c.children,i,r,a,s))}else if(n.type===$a.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,r,s){let o;if(null!=kc(i,n))return t;{const a=new Lc(i,t,r),c=t.eventCache.getNode();let l;if(Ho(n)||".priority"===Uo(n)){let n;if(t.serverCache.isFullyInitialized())n=Tc(i,ic(t));else{const e=t.serverCache.getNode();de(e instanceof Ca,"serverChildren would be complete if leaf node"),n=Ec(i,e)}l=e.filter.updateFullNode(c,n,s)}else{const r=Uo(n);let u=Rc(i,r,t.serverCache);null==u&&t.serverCache.isCompleteForChild(r)&&(u=c.getImmediateChild(r)),l=null!=u?e.filter.updateChild(c,r,u,Bo(n),a,s):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(c,r,Ca.EMPTY_NODE,Bo(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Tc(i,ic(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=kc(i,Mo()),ec(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,a.path,i,r,s):function(e,t,n,i,r,s,o){if(null!=kc(r,n))return t;const a=t.serverCache.isFiltered(),c=t.serverCache;if(null!=i.value){if(Ho(n)&&c.isFullyInitialized()||c.isCompleteForPath(n))return Mc(e,t,n,c.getNode().getChild(n),r,s,a,o);if(Ho(n)){let i=new sc(null);return c.getNode().forEachChild(ra,((e,t)=>{i=i.set(new Do(e),t)})),jc(e,t,n,i,r,s,a,o)}return t}{let l=new sc(null);return i.foreach(((e,t)=>{const i=Wo(n,e);c.isCompleteForPath(i)&&(l=l.set(e,c.getNode().getChild(i)))})),jc(e,t,n,l,r,s,a,o)}}(e,t,a.path,a.affectedTree,i,r,s)}else{if(n.type!==$a.LISTEN_COMPLETE)throw fe("Unknown operation type: "+n.type);o=function(e,t,n,i,r){const s=t.serverCache,o=tc(t,s.getNode(),s.isFullyInitialized()||Ho(n),s.isFiltered());return Dc(e,o,n,i,Pc,r)}(e,t,n.path,i,s)}const c=s.getChanges();return function(e,t,n){const i=t.eventCache;if(i.isFullyInitialized()){const r=i.getNode().isLeafNode()||i.getNode().isEmpty(),s=nc(e);(n.length>0||!e.eventCache.isFullyInitialized()||r&&!i.getNode().equals(s)||!i.getNode().getPriority().equals(s.getPriority()))&&n.push(Aa(nc(t)))}}(t,o,c),{viewCache:o,changes:c}}function Dc(e,t,n,i,r,s){const o=t.eventCache;if(null!=kc(i,n))return t;{let a,c;if(Ho(n))if(de(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=ic(t),r=Ec(i,n instanceof Ca?n:Ca.EMPTY_NODE);a=e.filter.updateFullNode(t.eventCache.getNode(),r,s)}else{const n=Tc(i,ic(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,s)}else{const l=Uo(n);if(".priority"===l){de(1===Fo(n),"Can't have a priority with additional path components");const r=o.getNode();c=t.serverCache.getNode();const s=Cc(i,n,r,c);a=null!=s?e.filter.updatePriority(r,s):o.getNode()}else{const u=Bo(n);let h;if(o.isCompleteForChild(l)){c=t.serverCache.getNode();const e=Cc(i,n,o.getNode(),c);h=null!=e?o.getNode().getImmediateChild(l).updateChild(u,e):o.getNode().getImmediateChild(l)}else h=Rc(i,l,t.serverCache);a=null!=h?e.filter.updateChild(o.getNode(),l,h,u,r,s):o.getNode()}}return ec(t,a,o.isFullyInitialized()||Ho(n),e.filter.filtersNodes())}}function Mc(e,t,n,i,r,s,o,a){const c=t.serverCache;let l;const u=o?e.filter:e.filter.getIndexedFilter();if(Ho(n))l=u.updateFullNode(c.getNode(),i,null);else if(u.filtersNodes()&&!c.isFiltered()){const e=c.getNode().updateChild(n,i);l=u.updateFullNode(c.getNode(),e,null)}else{const e=Uo(n);if(!c.isCompleteForPath(n)&&Fo(n)>1)return t;const r=Bo(n),s=c.getNode().getImmediateChild(e).updateChild(r,i);l=".priority"===e?u.updatePriority(c.getNode(),s):u.updateChild(c.getNode(),e,s,r,Pc,null)}const h=tc(t,l,c.isFullyInitialized()||Ho(n),u.filtersNodes());return Dc(e,h,n,r,new Lc(r,h,s),a)}function Uc(e,t,n,i,r,s,o){const a=t.eventCache;let c,l;const u=new Lc(r,t,s);if(Ho(n))l=e.filter.updateFullNode(t.eventCache.getNode(),i,o),c=ec(t,l,!0,e.filter.filtersNodes());else{const r=Uo(n);if(".priority"===r)l=e.filter.updatePriority(t.eventCache.getNode(),i),c=ec(t,l,a.isFullyInitialized(),a.isFiltered());else{const s=Bo(n),l=a.getNode().getImmediateChild(r);let h;if(Ho(s))h=i;else{const e=u.getCompleteChild(r);h=null!=e?".priority"===jo(s)&&e.getChild(qo(s)).isEmpty()?e:e.updateChild(s,i):Ca.EMPTY_NODE}if(l.equals(h))c=t;else{c=ec(t,e.filter.updateChild(a.getNode(),r,h,s,u,o),a.isFullyInitialized(),e.filter.filtersNodes())}}}return c}function Fc(e,t){return e.eventCache.isCompleteForChild(t)}function Bc(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function jc(e,t,n,i,r,s,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let c,l=t;c=Ho(n)?i:new sc(null).setTree(n,i);const u=t.serverCache.getNode();return c.children.inorderTraversal(((n,i)=>{if(u.hasChild(n)){const c=Bc(0,t.serverCache.getNode().getImmediateChild(n),i);l=Mc(e,l,new Do(n),c,r,s,o,a)}})),c.children.inorderTraversal(((n,i)=>{const c=!t.serverCache.isCompleteForChild(n)&&void 0===i.value;if(!u.hasChild(n)&&!c){const c=Bc(0,t.serverCache.getNode().getImmediateChild(n),i);l=Mc(e,l,new Do(n),c,r,s,o,a)}})),l}function zc(e,t){const n=ic(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!Ho(t)&&!n.getImmediateChild(Uo(t)).isEmpty())?n.getChild(t):null}function qc(e,t,n,i){t.type===$a.MERGE&&null!==t.source.queryId&&(de(ic(e.viewCache_),"We should always have a full cache before handling merges"),de(nc(e.viewCache_),"Missing event cache, even though we have a server cache"));const r=e.viewCache_,s=xc(e.processor_,r,t,n,i);var o,a;return o=e.processor_,a=s.viewCache,de(a.eventCache.getNode().isIndexed(o.filter.getIndex()),"Event snap not indexed"),de(a.serverCache.getNode().isIndexed(o.filter.getIndex()),"Server snap not indexed"),de(s.viewCache.serverCache.isFullyInitialized()||!r.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=s.viewCache,Wc(e,s.changes,s.viewCache.eventCache.getNode(),null)}function Wc(e,t,n,i){const r=i?[i]:e.eventRegistrations_;return function(e,t,n,i){const r=[],s=[];return t.forEach((t=>{var n;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hc,$c;function Vc(e,t,n,i){const r=t.source.queryId;if(null!==r){const s=e.views.get(r);return de(null!=s,"SyncTree gave us an op for an invalid query."),qc(s,t,n,i)}{let r=[];for(const s of e.views.values())r=r.concat(qc(s,t,n,i));return r}}function Kc(e,t){let n=null;for(const i of e.views.values())n=n||zc(i,t);return n}class Gc{constructor(e){this.listenProvider_=e,this.syncPointTree_=new sc(null),this.pendingWriteTree_={visibleWrites:oc.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Jc(e,t,n,i,r){return function(e,t,n,i,r){de(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=ac(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?tl(e,new Ja({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Yc(e,t,n,i){!function(e,t,n,i){de(i>e.lastWriteId,"Stacking an older merge on top of newer ones"),e.allWrites.push({path:t,children:n,writeId:i,visible:!0}),e.visibleWrites=cc(e.visibleWrites,t,n),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i);const r=sc.fromObject(n);return tl(e,new Ya({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,r))}function Qc(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(yc(e.pendingWriteTree_,t)){let t=new sc(null);return null!=i.snap?t=t.set(Mo(),!0):co(i.children,(e=>{t=t.set(new Do(e),!0)})),tl(e,new Ga(i.path,t,n))}return[]}function Xc(e,t,n){return tl(e,new Ja({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Zc(e,t,n,i){const r=rl(e,i);if(null!=r){const i=sl(r),s=i.path,o=i.queryId,a=$o(s,t);return ol(e,s,new Ja(Ka(o),a,n))}return[]}function el(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Kc(n,$o(e,t));if(i)return i}));return Ic(i,t,r,n,!0)}function tl(e,t){return nl(t,e.syncPointTree_,null,_c(e.pendingWriteTree_,Mo()))}function nl(e,t,n,i){if(Ho(e.path))return il(e,t,n,i);{const r=t.get(Mo());null==n&&null!=r&&(n=Kc(r,Mo()));let s=[];const o=Uo(e.path),a=e.operationForChild(o),c=t.children.get(o);if(c&&a){const e=n?n.getImmediateChild(o):null,t=Nc(i,o);s=s.concat(nl(a,c,e,t))}return r&&(s=s.concat(Vc(r,e,i,n))),s}}function il(e,t,n,i){const r=t.get(Mo());null==n&&null!=r&&(n=Kc(r,Mo()));let s=[];return t.children.inorderTraversal(((t,r)=>{const o=n?n.getImmediateChild(t):null,a=Nc(i,t),c=e.operationForChild(t);c&&(s=s.concat(il(c,r,o,a)))})),r&&(s=s.concat(Vc(r,e,i,n))),s}function rl(e,t){return e.tagToQueryMap.get(t)}function sl(e){const t=e.indexOf("$");return de(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Do(e.substr(0,t))}}function ol(e,t,n){const i=e.syncPointTree_.get(t);de(i,"Missing sync point for query tag that we're tracking");return Vc(i,n,_c(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class al{getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new al(t)}node(){return this.node_}constructor(e){this.node_=e}}class cl{getImmediateChild(e){const t=Wo(this.path_,e);return new cl(this.syncTree_,t)}node(){return el(this.syncTree_,this.path_)}constructor(e,t){this.syncTree_=e,this.path_=t}}const ll=function(e,t,n){return e&&"object"==typeof e?(de(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?ul(e[".sv"],t,n):"object"==typeof e[".sv"]?hl(e[".sv"],t):void de(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},ul=function(e,t,n){if("timestamp"===e)return n.timestamp;de(!1,"Unexpected server value: "+e)},hl=function(e,t,n){e.hasOwnProperty("increment")||de(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const i=e.increment;"number"!=typeof i&&de(!1,"Unexpected increment value: "+i);const r=t.node();if(de(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return i;const s=r.getValue();return"number"!=typeof s?i:s+i},dl=function(e,t,n,i){return pl(t,new cl(n,e),i)},fl=function(e,t,n){return pl(e,new al(t),n)};function pl(e,t,n){const i=e.getPriority().val(),r=ll(i,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const i=e,s=ll(i.getValue(),t,n);return s!==i.getValue()||r!==i.getPriority().val()?new ma(s,Sa(r)):e}{const i=e;return s=i,r!==i.getPriority().val()&&(s=s.updatePriority(new ma(r))),i.forEachChild(_a,((e,i)=>{const r=pl(i,t.getImmediateChild(e),n);r!==i&&(s=s.updateImmediateChild(e,r))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gl{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function ml(e,t){let n=t instanceof Do?t:new Do(t),i=e,r=Uo(n);for(;null!==r;){const e=je(i.node.children,r)||{children:{},childCount:0};i=new gl(r,i,e),n=Bo(n),r=Uo(n)}return i}function _l(e){return e.node.value}function yl(e,t){e.node.value=t,Tl(e)}function vl(e){return e.node.childCount>0}function wl(e,t){co(e.node.children,((n,i)=>{t(new gl(n,e,i))}))}function bl(e,t,n,i){n&&!i&&t(e),wl(e,(e=>{bl(e,t,!0,i)})),n&&i&&t(e)}function Il(e){return new Do(null===e.parent?e.name:Il(e.parent)+"/"+e.name)}function Tl(e){null!==e.parent&&function(e,t,n){const i=function(e){return void 0===_l(e)&&!vl(e)}(n),r=Be(e.node.children,t);i&&r?(delete e.node.children[t],e.node.childCount--,Tl(e)):i||r||(e.node.children[t]=n.node,e.node.childCount++,Tl(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const El=/[\[\].#$\/\u0000-\u001F\u007F]/,Cl=/[\[\].#$\u0000-\u001F\u007F]/,kl=function(e){return"string"==typeof e&&0!==e.length&&!El.test(e)},Sl=function(e){return"string"==typeof e&&0!==e.length&&!Cl.test(e)},Rl=function(e){return null===e||"string"==typeof e||"number"==typeof e&&!no(e)||e&&"object"==typeof e&&Be(e,".sv")},Nl=function(e,t,n){const i=n instanceof Do?new Jo(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Qo(i));if("function"==typeof t)throw new Error(e+"contains a function "+Qo(i)+" with contents = "+t.toString());if(no(t))throw new Error(e+"contains "+t.toString()+" "+Qo(i));if("string"==typeof t&&t.length>10485760/3&&et(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Qo(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,r=!1;if(co(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(r=!0,!kl(t)))throw new Error(e+" contains an invalid key ("+t+") "+Qo(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=i).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=et(a),Yo(o),Nl(e,s,i),function(e){const t=e.parts_.pop();e.byteLength_-=et(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&r)throw new Error(e+' contains ".value" child '+Qo(i)+" in addition to actual children.")}},Ol=function(e,t,n,i){if(i&&void 0===t)return;const r=Xe(e,"values");if(!t||"object"!=typeof t||Array.isArray(t))throw new Error(r+" must be an object containing the children to replace.");const s=[];co(t,((e,t)=>{const i=new Do(e);if(Nl(r,t,Wo(n,i)),".priority"===jo(i)&&!Rl(t))throw new Error(r+"contains an invalid value for '"+i.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(i)})),function(e,t){let n,i;for(n=0;n<t.length;n++){i=t[n];const r=zo(i);for(let t=0;t<r.length;t++)if(".priority"===r[t]&&t===r.length-1);else if(!kl(r[t]))throw new Error(e+"contains an invalid key ("+r[t]+") in path "+i.toString()+'. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"')}t.sort(Vo);let r=null;for(n=0;n<t.length;n++){if(i=t[n],null!==r&&Go(r,i))throw new Error(e+"contains a path "+r.toString()+" that is ancestor of another path "+i.toString());r=i}}(r,s)},Al=function(e,t,n,i){if(!(i&&void 0===n||Sl(n)))throw new Error(Xe(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Pl=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!kl(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Sl(e)}(n))throw new Error(Xe(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ll{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function xl(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||Ko(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function Dl(e,t,n){xl(e,n),Ml(e,(e=>Go(e,t)||Go(t,e)))}function Ml(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Ul(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Ul(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Gs&&Qs("event: "+n.toString()),fo(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fl{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Ll,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=ja(),this.transactionQueueTree_=new gl,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function Bl(e,t,n){if(e.stats_=Eo(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new Fa(e.repoInfo_,((t,n,i,r)=>{ql(e,t,n,i,r)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>Wl(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{De(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Zo(e.repoInfo_,t,((t,n,i,r)=>{ql(e,t,n,i,r)}),(t=>{Wl(e,t)}),(t=>{!function(e,t){co(t,((t,n)=>{Hl(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return To[n]||(To[n]=t()),To[n]}(e.repoInfo_,(()=>new Ha(e.stats_,e.server_))),e.infoData_=new Ba,e.infoSyncTree_=new Gc({startListening:(t,n,i,r)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=Xc(e.infoSyncTree_,t._path,o),setTimeout((()=>{r("ok")}),0)),s},stopListening:()=>{}}),Hl(e,"connected",!1),e.serverSyncTree_=new Gc({startListening:(t,n,i,r)=>(e.server_.listen(t,i,n,((n,i)=>{const s=r(n,i);Dl(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function jl(e){const t=e.infoData_.getNode(new Do(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function zl(e){return(t=(t={timestamp:jl(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function ql(e,t,n,i,r){e.dataUpdateCount++;const s=new Do(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(r)if(i){const t=qe(n,(e=>Sa(e)));o=function(e,t,n,i){const r=rl(e,i);if(r){const i=sl(r),s=i.path,o=i.queryId,a=$o(s,t),c=sc.fromObject(n);return ol(e,s,new Ya(Ka(o),a,c))}return[]}(e.serverSyncTree_,s,t,r)}else{const t=Sa(n);o=Zc(e.serverSyncTree_,s,t,r)}else if(i){const t=qe(n,(e=>Sa(e)));o=function(e,t,n){const i=sc.fromObject(n);return tl(e,new Ya({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,s,t)}else{const t=Sa(n);o=Xc(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=Ql(e,s)),Dl(e.eventQueue_,a,o)}function Wl(e,t){Hl(e,"connected",t),!1===t&&function(e){Kl(e,"onDisconnectEvents");const t=zl(e),n=ja();qa(e.onDisconnect_,Mo(),((i,r)=>{const s=dl(i,r,e.serverSyncTree_,t);za(n,i,s)}));let i=[];qa(n,Mo(),((t,n)=>{i=i.concat(Xc(e.serverSyncTree_,t,n));const r=nu(e,t);Ql(e,r)})),e.onDisconnect_=ja(),Dl(e.eventQueue_,Mo(),i)}(e)}function Hl(e,t,n){const i=new Do("/.info/"+t),r=Sa(n);e.infoData_.updateSnapshot(i,r);const s=Xc(e.infoSyncTree_,i,r);Dl(e.eventQueue_,i,s)}function $l(e){return e.nextWriteId_++}function Vl(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function Kl(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),Qs(n,...t)}function Gl(e,t,n,i){t&&fo((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let r=e;i&&(r+=": "+i);const s=new Error(r);s.code=e,t(s)}}))}function Jl(e,t,n){return el(e.serverSyncTree_,t,n)||Ca.EMPTY_NODE}function Yl(e,t=e.transactionQueueTree_){if(t||tu(e,t),_l(t)){const n=Zl(e,t);de(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const i=n.map((e=>e.currentWriteId)),r=Jl(e,t,i);let s=r;const o=r.hash();for(let e=0;e<n.length;e++){const i=n[e];de(0===i.status,"tryToSendTransactionQueue_: items in queue should all be run."),i.status=1,i.retryCount++;const r=$o(t,i.path);s=s.updateChild(r,i.currentOutputSnapshotRaw)}const a=s.val(!0),c=t;e.server_.put(c.toString(),a,(i=>{Kl(e,"transaction put response",{path:c.toString(),status:i});let r=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,r=r.concat(Qc(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();tu(e,ml(e.transactionQueueTree_,t)),Yl(e,e.transactionQueueTree_),Dl(e.eventQueue_,t,r);for(let e=0;e<i.length;e++)fo(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{to("transaction at "+c.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}Ql(e,t)}}),o)}(e,Il(t),n)}else vl(t)&&wl(t,(t=>{Yl(e,t)}))}function Ql(e,t){const n=Xl(e,t),i=Il(n);return function(e,t,n){if(0===t.length)return;const i=[];let r=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const c=t[a],l=$o(n,c.path);let u,h=!1;if(de(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null."),4===c.status)h=!0,u=c.abortReason,r=r.concat(Qc(e.serverSyncTree_,c.currentWriteId,!0));else if(0===c.status)if(c.retryCount>=25)h=!0,u="maxretry",r=r.concat(Qc(e.serverSyncTree_,c.currentWriteId,!0));else{const n=Jl(e,c.path,s);c.currentInputSnapshot=n;const i=t[a].update(n.val());if(void 0!==i){Nl("transaction failed: Data returned ",i,c.path);let t=Sa(i);"object"==typeof i&&null!=i&&Be(i,".priority")||(t=t.updatePriority(n.getPriority()));const o=c.currentWriteId,a=zl(e),l=fl(t,n,a);c.currentOutputSnapshotRaw=t,c.currentOutputSnapshotResolved=l,c.currentWriteId=$l(e),s.splice(s.indexOf(o),1),r=r.concat(Jc(e.serverSyncTree_,c.path,l,c.currentWriteId,c.applyLocally)),r=r.concat(Qc(e.serverSyncTree_,o,!0))}else h=!0,u="nodata",r=r.concat(Qc(e.serverSyncTree_,c.currentWriteId,!0))}Dl(e.eventQueue_,n,r),r=[],h&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===u?i.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):i.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var o;tu(e,e.transactionQueueTree_);for(let e=0;e<i.length;e++)fo(i[e]);Yl(e,e.transactionQueueTree_)}(e,Zl(e,n),i),i}function Xl(e,t){let n,i=e.transactionQueueTree_;for(n=Uo(t);null!==n&&void 0===_l(i);)i=ml(i,n),n=Uo(t=Bo(t));return i}function Zl(e,t){const n=[];return eu(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function eu(e,t,n){const i=_l(t);if(i)for(let e=0;e<i.length;e++)n.push(i[e]);wl(t,(t=>{eu(e,t,n)}))}function tu(e,t){const n=_l(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,yl(t,n.length>0?n:void 0)}wl(t,(t=>{tu(e,t)}))}function nu(e,t){const n=Il(Xl(e,t)),i=ml(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{iu(e,t)})),iu(e,i),bl(i,(t=>{iu(e,t)})),n}function iu(e,t){const n=_l(t);if(n){const i=[];let r=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(de(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(de(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(Qc(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?yl(t,void 0):n.length=s+1,Dl(e.eventQueue_,Il(t),r);for(let e=0;e<i.length;e++)fo(i[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ou{get key(){return Ho(this._path)?null:jo(this._path)}get ref(){return new au(this._repo,this._path)}get _queryIdentifier(){const e=Ua(this._queryParams),t=oo(e);return"{}"===t?"default":t}get _queryObject(){return Ua(this._queryParams)}isEqual(e){if(!((e=nt(e))instanceof ou))return!1;const t=this._repo===e._repo,n=Ko(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}}class au extends ou{get parent(){const e=qo(this._path);return null===e?null:new au(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new Da,!1)}}function cu(e,t){return(e=nt(e))._checkNotDeleted("ref"),void 0!==t?lu(e._root,t):e._root}function lu(e,t){var n,i,r,s;return null===Uo((e=nt(e))._path)?(n="child",i="path",s=!1,(r=t)&&(r=r.replace(/^\/*\.info(\/|$)/,"/")),Al(n,i,r,s)):Al("child","path",t,!1),new au(e._repo,Wo(e._path,t))}function uu(e,t){Ol("update",t,e._path,!1);const n=new be;return function(e,t,n,i){Kl(e,"update",{path:t.toString(),value:n});let r=!0;const s=zl(e),o={};if(co(n,((n,i)=>{r=!1,o[n]=dl(Wo(t,n),Sa(i),e.serverSyncTree_,s)})),r)Qs("update() called with empty data.  Don't do anything."),Gl(0,i,"ok",void 0);else{const r=$l(e),s=Yc(e.serverSyncTree_,t,o,r);xl(e.eventQueue_,s),e.server_.merge(t.toString(),n,((n,s)=>{const o="ok"===n;o||to("update at "+t+" failed: "+n);const a=Qc(e.serverSyncTree_,r,!o),c=a.length>0?Ql(e,t):t;Dl(e.eventQueue_,c,a),Gl(0,i,n,s)})),co(n,(n=>{const i=nu(e,Wo(t,n));Ql(e,i)})),Dl(e.eventQueue_,t,[])}}(e._repo,e._path,t,n.wrapCallback((()=>{}))),n.promise}!function(e){de(!Hc,"__referenceConstructor has already been defined"),Hc=e}(au),function(e){de(!$c,"__referenceConstructor has already been defined"),$c=e}(au);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const hu={};let du=!1;function fu(e,t,n,i,r){let s=i||e.options.databaseURL;void 0===s&&(e.options.projectId||eo("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Qs("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,c=ru(s,r),l=c.repoInfo;void 0!==Us&&Us.env&&(a=Us.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${l.namespace}`,c=ru(s,r),l=c.repoInfo):o=!c.repoInfo.secure;const u=r&&o?new _o(_o.OWNER):new mo(e.name,e.options,t);Pl("Invalid Firebase Database URL",c),Ho(c.path)||eo("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,i){let r=hu[t.name];r||(r={},hu[t.name]=r);let s=r[e.toURLString()];s&&eo("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new Fl(e,du,n,i),r[e.toURLString()]=s,s}(l,e,u,new go(e.name,n));return new pu(h,e)}class pu{get _repo(){return this._instanceStarted||(Bl(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new au(this._repo,Mo())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=hu[t];n&&n[e.key]===e||eo(`Database ${t}(${e.repoInfo_}) has already been deleted.`),Vl(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&eo("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}Zo.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Zo.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Fs="9.9.2",Ut(new it("database",((e,{instanceIdentifier:t})=>fu(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),qt("@firebase/database","0.13.4",e),qt("@firebase/database","0.13.4","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();!function(e=zt()){const t=Ft(e=nt(e),"analytics");t.isInitialized()?t.getImmediate():function(e,t={}){const n=Ft(e,"analytics");if(n.isInitialized()){const e=n.getImmediate();if(We(t,n.getOptions()))return e;throw Mn.create("already-initialized")}n.initialize({options:t})}(e)}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw Bt.create("bad-app-name",{appName:String(i)});const r=xt.get(i);if(r){if(We(e,r.options)&&We(n,r.config))return r;throw Bt.create("duplicate-app",{appName:i})}const s=new st(i);for(const e of Dt.values())s.addComponent(e);const o=new jt(e,n,s);return xt.set(i,o),o}({apiKey:"AIzaSyCC8_MgK1himNe24DycvtKn4eILHfsNlGI",authDomain:"js-project-69603.firebaseapp.com",projectId:"js-project-69603",storageBucket:"js-project-69603.appspot.com",messagingSenderId:"723891192902",appId:"1:723891192902:web:56cac8a0bb673caa127647",measurementId:"G-FPFJ79VJJ6",databaseURL:"https://js-project-69603-default-rtdb.europe-west1.firebasedatabase.app/"}));const gu=new Tr,mu=
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e=zt()){const t=Ft(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Ft(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(We(n.getOptions(),null!=t?t:{}))return e;ui(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:xs,persistence:[Jr,Dr,Ur]})}(),_u=function(e=zt(),t){return Ft(e,"database").getImmediate({identifier:t})}(),yu=async()=>{await as(mu,gu).then((e=>{Tr.credentialFromResult(e).accessToken,e.user;console.log(writeUserData())})).catch((e=>{e.code,e.message,e.customData.email,Tr.credentialFromError(e)}))};function vu(){var e;(e=mu,nt(e).signOut()).then((()=>{})).catch((e=>{}))}var wu,bu,Iu;function Tu(e){const t={};t[e]=e;try{uu(cu(_u,"favourite/"+mu.currentUser.uid+"/cocktails/"),t)}catch(e){console.log(e)}}wu=e=>{!function(e){if(e)return void(P.textContent="logOut");P.textContent="logIn"}(e)},nt(mu).onAuthStateChanged(wu,bu,Iu),P.addEventListener("click",(async function(e){if("logIn"===e.target.textContent)return void await yu();return void vu()})),C.addEventListener("click",(e=>{if("favourite"===e.target.dataset.action){Tu(e.target.parentElement.parentElement.id)}}));t(o)((function(){C.innerHTML=D()}),200);
//!!! Initial page loading !!!
!async function(){X(Q),Z(Q),await ce(),C.addEventListener("click",(e=>re(e))),S.addEventListener("click",(e=>ae(e))),k.addEventListener("click",se),oe()}();
//# sourceMappingURL=favourite_cocktails.e470188d.js.map
